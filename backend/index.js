...
mongoose
  .connect('mongodb+srv://root:1234@auth.nsrhyxd.mongodb.net/blog?retryWrites=true&w=majority')
...
app.post('/comments', checkAuth, commentCreateValidation, handleValidationErrors, CommentController.createComment);
app.get('/comments/post/:id', CommentController.getCommentsByPostId); 
